    ...
    <>
      ...
      <div id="career-paragraph">
        <p>
          ...
          <br />
          and be rewarded for it. This has contributed to a phenomenal team that
          is strong and able and this sort of functionality gives us the freedom
          to focus on our
          <br />
          core business practice and what we do best. It has allowed us to serve
          our clients to the best of our ability, achieving their satisfaction,
      ...
      <div id="elements2" classname="flex-container">
        <div id="careers-featured-roles">
        ...
        <div id="careers-form">
          <form >
            ...
            <br />
            <br />
            <input type="button" placeholder="Choose a file..." />
          </form>
        </div>
      </div>
    </>
